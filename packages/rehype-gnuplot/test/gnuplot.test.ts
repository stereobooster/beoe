...
it("removes xml doctype", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`"<div class="datt gnuplot"><svg viewBox="0 0 1000 500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><title>Gnuplot</title><desc>Produced by GNUPLOT 5.4 patchlevel 0</desc><g id="gnuplot_canvas"><rect x="0" y="0" width="1000" height="500" fill="#ffffff"/></g></svg></div>"`);
});
